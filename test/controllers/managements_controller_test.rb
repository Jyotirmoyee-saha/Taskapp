...
class ManagementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create management" do
    assert_difference("Management.count") do
      post managements_url, params: { management: { project_id: @management.project_id, user_id: @management.user_id } }
    end
  ...
  test "should update management" do
    patch management_url(@management), params: { management: { project_id: @management.project_id, user_id: @management.user_id } }
